import { IconFontSizes, HighContrastSelector, getPlaceholderStyles, normalize, getGlobalClassNames } from '@/styling'
...
import { AnimationClassNames } from '@/styling/classNames/AnimationClassNames'
