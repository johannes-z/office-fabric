...
Vue.use(Fabric, {} as IPartialTheme, {} as IOptions)
      ...
      <p>
        ...
        Office UI Fabric Vue everywhere by for example using <code>&lt;f-toggle /&gt;</code>. The prefix <code>f-</code>
        can be overridden using the Vue Plugin options.
      </p>
