...
import type { DirectionalHint, ICalloutProps } from '..'
 ...
 * {@docCategory Tooltip}
 */
export interface ITooltipProps extends Omit<HTMLAttributes, 'content'> {
  /**
  ...
  /**
   * Additional css class to apply to the Tooltip
