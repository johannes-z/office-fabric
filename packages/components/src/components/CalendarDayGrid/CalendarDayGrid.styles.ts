import { AnimationStyles, FontSizes, FontWeights, HighContrastSelector, type IRawStyle, getFocusStyle, getGlobalClassNames, getHighContrastNoAdjustStyle, keyframes } from '@fluentui-vue/style-utilities'
...
export function getStyles(props: ICalendarDayGridStyleProps): ICalendarDayGridStyles {
  const {
    theme,
    dateRangeType,
    showWeekNumbers,
