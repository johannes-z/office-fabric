import type { DirectionalHint, ICalloutPositionedInfo, IRectangle, Point, Rectangle } from '@fluentui-vue/utilities'
import type { ITheme } from '@fluentui-vue/theme'
import type { IStyle, IStyleFunctionOrObject } from '@fluentui/merge-styles'
import type { HTMLAttributes, StyleValue, VNode } from 'vue';
import type { ILayerProps } from '..';
import type { IPopupProps, IPopupRestoreFocusParams } from '../Popup';

/**
 * {@docCategory Callout}
 */
export interface ICalloutProps extends HTMLAttributes {
  /**
   ...
   */
  preventDismissOnEvent?: (ev: Event | FocusEvent | KeyboardEvent | MouseEvent) => boolean;
   ...
   */
  onDismiss?: (ev?: Event | MouseEvent | KeyboardEvent) => void;
...
export type Target = Element | string | MouseEvent | Point | Rectangle | null | VNode;