...
import { DirectionalHint, RectangleEdge, classNamesFunction, divProperties, getBoundsFromTargetWindow, getMaxHeight, positionCallout, getNativeProps } from '@fluentui-vue/utilities'
...
export const CalloutContentBase = defineComponent({
  ...
  props: {
    ...
    positions: { type: Object as () => ICalloutPositionedInfo, default: undefined },
