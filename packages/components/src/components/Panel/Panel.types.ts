...
import type { IFocusTrapZoneProps, ILayerProps } from '..'
 ...
 * {@docCategory Panel}
 */
export interface IPanelProps extends HTMLAttributes {
  /**
   ...
   */
  headerTextProps?: HTMLAttributes
   ...
   */
  onDismiss?: (ev?: KeyboardEvent) => void
