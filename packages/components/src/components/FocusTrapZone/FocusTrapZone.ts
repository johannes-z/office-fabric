import { classNamesFunction, divProperties, focusAsync, getFirstTabbable, getId, getLastTabbable, getNativeProps, getNextElement, getWindow, modalize, on } from '@fluentui-vue/utilities'
import { elementContains } from '@fluentui/dom-utilities'
import { usePrevious } from '@vueuse/core'
import { type VNodeRef, computed, defineComponent, h, onBeforeUnmount, onUnmounted, ref, toRefs, watch, watchEffect } from 'vue'
