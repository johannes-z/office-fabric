import { AnimationStyles, FontSizes, FontWeights, HighContrastSelector, type IRawStyle, getFocusStyle, getHighContrastNoAdjustStyle, normalize } from '@fluentui-vue/style-utilities'
...
export function getStyles(props: ICalendarPickerStyleProps): ICalendarPickerStyles {
  const {
    className,
    theme,
