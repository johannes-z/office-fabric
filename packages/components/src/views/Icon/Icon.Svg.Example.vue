...
import { FontIcon, mergeStyleSets, mergeStyles, registerIcons } from '@fluentui-vue/components'
...
<template>
  <div>
    <FontIcon aria-label="OneDrive logo" icon-name="onedrive-svg" :class="iconClass" />
    <FontIcon
