...
export interface IComboBoxProps {
   ...
   */
  onItemClick?: (event: any, option?: IComboBoxOption, index?: number) => void;
   ...
   */
  onChange?: (event: any, option?: IComboBoxOption, index?: number, value?: string) => void;
   ...
   */
  onRenderUpperContent?: any;

  /**
   * Add additional content below the callout list.
   */
  onRenderLowerContent?: any;
