...
import { IDragDropEvents, IDragDropContext, IDragDropHelper, IDragDropOptions } from '../../utils/dragdrop/index'
// import { IGroup, IGroupRenderProps, IGroupDividerProps, IGroupedListProps } from '../GroupedList/index'
import { IDetailsRowProps, IDetailsRowBaseProps, ICellStyleProps, IDetailsItemProps } from './DetailsRow/DetailsRow.types'
import { IDetailsHeaderProps, IDetailsHeaderBaseProps } from './DetailsHeader/DetailsHeader.types'
...
export interface IDetailsListProps {
  ...
  onColumnHeaderClick?: (ev?: MouseEvent, column?: IColumn) => void;

  /** Callback for when the user asks for a contextual menu (usually via right click) from a column header. */
  onColumnHeaderContextMenu?: (column?: IColumn, ev?: MouseEvent) => void;
  ...
  onRenderMissingItem?: (index?: number, rowProps?: IDetailsRowProps) => any;
  ...
  onActiveItemChanged?: (item?: any, index?: number, ev?: FocusEvent) => void;
   ...
   */
  getGroupHeight?: any['getGroupHeight'];
 ...
 * {@docCategory DetailsList}
 */
export interface IDetailsGroupDividerProps extends IDetailsItemProps {}
