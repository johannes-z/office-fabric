import { getFocusStyle, focusClear, IStyle, getGlobalClassNames, HighContrastSelector, hiddenContentStyle, ITheme } from '@uifabric/styling'
...
// import { any } from '../DetailsRow/DetailsRow.types'
...
export const getCellStyles = (props: { theme: ITheme; cellStyleProps?: any }): IStyle => {
  ...
  return {
    ...
    cellIsGroupExpander: [
      cellStyles,
      {
        ...
        padding: 0,
        border: 'none',
        width: 10, // align with GroupedList's first expandIcon cell width.
