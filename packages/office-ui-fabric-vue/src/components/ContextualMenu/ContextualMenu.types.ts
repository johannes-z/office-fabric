...
export interface IContextualMenuListProps {
  ...
  hasCheckmarks: boolean;
  hasIcons: boolean;
  defaultMenuItemRenderer: (item: IContextualMenuItemRenderProps) => any;
}
...
export interface IContextualMenuItem {
   ...
   */
  onRender?: (item: any, dismissMenu: (ev?: any, dismissAll?: boolean) => void) => any;
