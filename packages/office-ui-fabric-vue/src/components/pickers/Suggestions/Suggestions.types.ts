import { IStyleFunctionOrObject, KeyCodes } from '@uifabric-vue/utilities'
...
export interface ISuggestionsProps<T> {
   ...
   */
  onSuggestionClick: (ev?: MouseEvent, item?: any, index?: number) => void;
   ...
   */
  onSuggestionRemove?: (ev?: MouseEvent, item?: T | IPersonaProps, index?: number) => void;
