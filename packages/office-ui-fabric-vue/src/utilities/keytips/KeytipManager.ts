// import { any } from '../../Keytip'
import { EventGroup, getId } from '@uifabric-vue/utilities'
...
export class KeytipManager {
  ...
  public sequenceMapping: { [key: string]: any } = {};
   ...
   */
  public register (keytipProps: any, persisted: boolean = false): string {
    let props: any = keytipProps
    if (!persisted) {
   ...
   */
  public update (keytipProps: any, uniqueID: string): void {
   ...
   *
   * @param keytipToRemove - any of the keytip to remove
   * @param uniqueID - Unique ID of this keytip
   * @param persisted - T/F if this keytip should be persisted, default is false
   */
  public unregister (keytipToRemove: any, uniqueID: string, persisted: boolean = false): void {
  ...
  /**
   * Gets all any from this.keytips
   *
   * @returns {any[]} All keytips stored in the manager
   */
  public getKeytips (): any[] {
   ...
   * @returns {any} - Modified keytip props, if needed to be modified
   */
  public addParentOverflow (keytipProps: any): any {
   ...
   *
   * @param keytipProps - any
   * @param uniqueID - Unique ID, will default to the next unique ID if not passed
   * @returns {IUniqueKeytip} IUniqueKeytip object
   */
  private _getUniqueKtp (keytipProps: any, uniqueID: string = getId()): IUniqueKeytip {
