  ...
  <BasePage>
    ...
    <template #usage>
      <div>
        ...
        <f-icon icon-name="TrainSolid" :class="iconClass" />
      </div>

      <h2>Icon with custom color</h2>
      <div>
        <f-icon icon-name="CompassNW" :class="classNames.deepSkyBlue" />
        <f-icon icon-name="Dictionary" :class="classNames.greenYellow" />
        <f-icon icon-name="TrainSolid" :class="classNames.salmon" />
      </div>

      <h2>Icon using custom svg</h2>
      <div>
        <f-icon icon-name="onedrive-svg" :class="iconClass" />
        <f-icon icon-name="yammer-svg"
                :class="mergeStyles(iconClass, {
                  fill: 'red',
                  selectors: {
                    '.thing': {
                      fill: 'green'
    ...
    'borderblinds-svg': h => (
      <svg viewBox="0 0 40 40" style={{ marginLeft: 'calc(50% - 0.5em)' }}>
        <g transform="scale(0.03125 0.03125)">
          <path class="borderblinds-part1" d="M0 192l320-128v768l-320 128z" />
          <path class="borderblinds-part2" d="M384 32l320 192v736l-320-160z" />
...
const BorderBlindsIcon = Vue.extend({
  functional: true,
  props: {
    color1: {
      type: String,
  ...
  render (h, ctx) {
    return (
      <Icon icon-name="borderblinds-svg" class-name={mergeStyles(iconClass, {
        ...
        selectors: {
          '.borderblinds-part1': {
            fill: ctx.props.color1,
          },
          '.borderblinds-part2': {
            fill: ctx.props.color2,
          },
          '.borderblinds-part3': {
            fill: ctx.props.color3,
          },
        },
      })} />
    )
