...
import _defineProperty$2 from '../../../node_modules/@babel/runtime/helpers/esm/defineProperty';
import _classCallCheck$2 from '../../../node_modules/@babel/runtime/helpers/esm/classCallCheck';
import _createClass$2 from '../../../node_modules/@babel/runtime/helpers/esm/createClass';
...
import _typeof2 from '../../../node_modules/@babel/runtime/helpers/esm/typeof';
import { Stylesheet, mergeStyles, setRTL as setRTL$1, mergeCssSets, keyframes, fontFace, concatStyleSets, mergeStyleSets, concatStyleSetsWithProps } from '@uifabric/merge-styles';
...
function classNamesFunction() {
  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}; // We build a trie where each node is a Map. The map entry key represents an argument
...
function getDocument$1(rootElement) {
...
var _window$1; // Note: Accessing "window" in IE11 is somewhat expensive, and calling "typeof window"
// hits a memory leak, whereas aliasing it and calling "typeof _window" does not.
// Caching the window value at the file scope lets us minimize the impact.
...
var _memoizedClassNames$1 = 0;
var stylesheet$3 = Stylesheet.getInstance();

if (stylesheet$3 && stylesheet$3.onReset) {
  stylesheet$3.onReset(function () {
    return _memoizedClassNames$1++;
  });
} // Note that because of the caching nature within the classNames memoization,


var _DirectionalKeyCodes$1;

var DirectionalKeyCodes$1 = (_DirectionalKeyCodes$1 = {}, _defineProperty$1$1(_DirectionalKeyCodes$1, KeyCodes$1.up, 1), _defineProperty$1$1(_DirectionalKeyCodes$1, KeyCodes$1.down, 1), _defineProperty$1$1(_DirectionalKeyCodes$1, KeyCodes$1.left, 1), _defineProperty$1$1(_DirectionalKeyCodes$1, KeyCodes$1.right, 1), _defineProperty$1$1(_DirectionalKeyCodes$1, KeyCodes$1.home, 1), _defineProperty$1$1(_DirectionalKeyCodes$1, KeyCodes$1.end, 1), _defineProperty$1$1(_DirectionalKeyCodes$1, KeyCodes$1.tab, 1), _defineProperty$1$1(_DirectionalKeyCodes$1, KeyCodes$1.pageUp, 1), _defineProperty$1$1(_DirectionalKeyCodes$1, KeyCodes$1.pageDown, 1), _DirectionalKeyCodes$1);
var IsFocusVisibleClassName$1 = 'ms-Fabric--isFocusVisible';
/**
...
function () {
  function GlobalSettings() {
    _classCallCheck$1(this, GlobalSettings);
  }

  _createClass$1(GlobalSettings, null, [{
    key: "getValue",
...
function _getGlobalSettings() {
  ...
  if (!globalObj[GLOBAL_SETTINGS_PROP_NAME]) {
    globalObj[GLOBAL_SETTINGS_PROP_NAME] = _defineProperty$1$1({}, CALLBACK_STATE_PROP_NAME, {});
  }
...
var stylesheet$1$1 = Stylesheet.getInstance();

if (stylesheet$1$1 && stylesheet$1$1.onReset) {
  Stylesheet.getInstance().onReset(resetMemoizations$1);
}

var _resetCounter$1 = 0;
var _emptyObject$1 = {
  empty: true
};
var _dictionary$1 = {};

var _weakMap$1 = typeof WeakMap === 'undefined' ? null : WeakMap;
/**
 * Reset memoizations.
 */


function resetMemoizations$1() {
  _resetCounter$1++;
}
/**
 * Memoizes a function; when you pass in the same parameters multiple times, it returns a cached result.
...
function memoizeFunction$1(cb) {
  ...
  var rootNode;
  var cacheSize = 0;
  var localResetCounter = _resetCounter$1; // tslint:disable-next-line:no-function-expression

  return function memoizedFunction() {
    var currentNode = rootNode;

    if (rootNode === undefined || localResetCounter !== _resetCounter$1 || maxCacheSize > 0 && cacheSize > maxCacheSize) {
      rootNode = _createNode$1();
      cacheSize = 0;
      localResetCounter = _resetCounter$1;
    }

    currentNode = rootNode; // Traverse the tree until we find the match.

    for (var i = 0; i < arguments.length; i++) {
      var arg = _normalizeArg$1(i < 0 || arguments.length <= i ? undefined : arguments[i]);

      if (!currentNode.map.has(arg)) {
        currentNode.map.set(arg, _createNode$1());
      }
...
function _normalizeArg$1(val) {
  if (!val) {
    return _emptyObject$1;
  } else if (_typeof$1$1(val) === 'object' || typeof val === 'function') {
    return val;
  } else if (!_dictionary$1[val]) {
    _dictionary$1[val] = {
      val: val
    };
  }

  return _dictionary$1[val];
}

function _createNode$1() {
  return {
    map: _weakMap$1 ? new _weakMap$1() : null
  };
}
/**
...
var CURRENT_ID_PROPERTY$1 = '__currentId__';

var _global$1 = getWindow$1() || {};

if (_global$1[CURRENT_ID_PROPERTY$1] === undefined) {
  _global$1[CURRENT_ID_PROPERTY$1] = 0;
}
/**
 * Resets id counter to an (optional) number.
 *
...
function resetIds$1() {
  var counter = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  _global$1[CURRENT_ID_PROPERTY$1] = counter;
}

var stylesheet$2$1 = Stylesheet.getInstance();

if (stylesheet$2$1 && stylesheet$2$1.onReset) {
  stylesheet$2$1.onReset(resetIds$1);
}

var DisabledScrollClassName$1 = mergeStyles({
  overflow: 'hidden !important'
});
...
var stylesheet$3$1 = Stylesheet.getInstance();

if (stylesheet$3$1 && stylesheet$3$1.onReset) {
  stylesheet$3$1.onReset(function () {
...
function _getFontBaseUrl() {
  var win = getWindow$1(); // tslint:disable-next-line:no-string-literal no-any
...
function _getFocusStyleInternal(theme) {
  ...
  return {
    ...
    position: position,
    selectors: _defineProperty$1({
      // Clear the focus border in Firefox.
      // Reference: http://stackoverflow.com/a/199319/1436671
      '::-moz-focus-inner': {
        border: '0'
      }
    }, ".".concat(IsFocusVisibleClassName$1, " &").concat(isFocusedOnly ? ':focus' : '', ":after"), {
      content: '""',
      position: 'absolute',
      left: inset + 1,
      top: inset + 1,
      ...
      selectors: _defineProperty$1({}, HighContrastSelector, highContrastStyle)
    })
  };
}
/**
...
var _getGlobalClassNames = memoizeFunction$1(function (classNames, disableGlobalClassNames) {
  var styleSheet = Stylesheet.getInstance();
...
function _defineGetter(obj, colorName, suffix, isHover, cssProperty) {
  Object.defineProperty(obj, colorName + suffix, {
    get: function get() {
      // tslint:disable-next-line:no-any
      var style = _defineProperty$1({}, cssProperty, getTheme().palette[colorName]);
    ...
    isCompactIcon: {
      ...
      selectors: {
        '.ms-Persona-imageArea': {
          ...
          borderRadius: '50%',
          selectors: _defineProperty$2({}, HighContrastSelector, {
            border: 'none',
            margin: '0'
          })
        }
...
var getBaseButtonClassNames = memoizeFunction(function (theme, styles, className, variantClassName, iconClassName, menuIconClassName, disabled, hasMenu, checked, expanded, isSplit) {
  ...
  return mergeStyleSets({
    root: [classNames.msButton, styles.root, variantClassName, checked && ['is-checked', styles.rootChecked], isExpanded && ['is-expanded', styles.rootExpanded, {
      selectors: (_selectors = {}, _defineProperty$2(_selectors, ":hover .".concat(classNames.msButtonIcon), styles.iconExpandedHovered), _defineProperty$2(_selectors, ":hover .".concat(classNames.msButtonMenuIcon), styles.menuIconExpandedHovered || styles.rootExpandedHovered), _defineProperty$2(_selectors, ':hover', styles.rootExpandedHovered), _selectors)
      ...
      }, _defineProperty$2(_selectors2, ":hover .".concat(classNames.msButtonLabel), styles.labelHovered), _defineProperty$2(_selectors2, ":hover .".concat(classNames.msButtonIcon), styles.iconHovered), _defineProperty$2(_selectors2, ":hover .".concat(classNames.msButtonDescription), styles.descriptionHovered), _defineProperty$2(_selectors2, ":hover .".concat(classNames.msButtonMenuIcon), styles.menuIconHovered), _defineProperty$2(_selectors2, ':focus', styles.rootFocused), _defineProperty$2(_selectors2, ':active', styles.rootPressed), _defineProperty$2(_selectors2, ":active .".concat(classNames.msButtonIcon), styles.iconPressed), _defineProperty$2(_selectors2, ":active .".concat(classNames.msButtonDescription), styles.descriptionPressed), _defineProperty$2(_selectors2, ":active .".concat(classNames.msButtonMenuIcon), styles.menuIconPressed), _selectors2)
...
var getStyles$4 = memoizeFunction(function (theme, customStyles, focusInset, focusColor) {
  ...
  var commandButtonStyles = {
    ...
    rootHovered: {
      ...
      color: p.neutralDark,
      selectors: (_selectors2 = {}, _defineProperty$2(_selectors2, HighContrastSelector, {
        color: 'Highlight'
      }), _defineProperty$2(_selectors2, ".".concat(ButtonGlobalClassNames.msButtonIcon), {
        color: p.themeDarkAlt
      }), _defineProperty$2(_selectors2, ".".concat(ButtonGlobalClassNames.msButtonMenuIcon), {
        color: p.neutralPrimary
      }), _selectors2)
    },
    rootPressed: {
      ...
      color: p.neutralDark,
      selectors: (_selectors3 = {}, _defineProperty$2(_selectors3, ".".concat(ButtonGlobalClassNames.msButtonIcon), {
        color: p.themeDark
      }), _defineProperty$2(_selectors3, ".".concat(ButtonGlobalClassNames.msButtonMenuIcon), {
        color: p.neutralPrimary
      }), _selectors3)
    },
    rootChecked: {
      backgroundColor: p.neutralLight,
      color: p.neutralDark,
      selectors: (_selectors4 = {}, _defineProperty$2(_selectors4, ".".concat(ButtonGlobalClassNames.msButtonIcon), {
        color: p.themeDark
      }), _defineProperty$2(_selectors4, ".".concat(ButtonGlobalClassNames.msButtonMenuIcon), {
        color: p.neutralPrimary
      }), _selectors4)
    },
    rootCheckedHovered: {
      backgroundColor: p.neutralQuaternaryAlt,
      selectors: (_selectors5 = {}, _defineProperty$2(_selectors5, ".".concat(ButtonGlobalClassNames.msButtonIcon), {
        color: p.themeDark
      }), _defineProperty$2(_selectors5, ".".concat(ButtonGlobalClassNames.msButtonMenuIcon), {
        color: p.neutralPrimary
      }), _selectors5)
    },
    rootExpanded: {
      backgroundColor: p.neutralLight,
      color: p.neutralDark,
      selectors: (_selectors6 = {}, _defineProperty$2(_selectors6, ".".concat(ButtonGlobalClassNames.msButtonIcon), {
        color: p.themeDark
      }), _defineProperty$2(_selectors6, ".".concat(ButtonGlobalClassNames.msButtonMenuIcon), {
        color: p.neutralPrimary
      }), _selectors6)
    },
    rootExpandedHovered: {
    ...
    rootDisabled: {
      backgroundColor: p.white,
      selectors: _defineProperty$2({}, ".".concat(ButtonGlobalClassNames.msButtonIcon), {
    ...
    splitButtonMenuButton: {
      ...
      selectors: {
        ':hover': {
          backgroundColor: p.neutralLighter,
          color: p.neutralDark,
          selectors: (_selectors9 = {}, _defineProperty$2(_selectors9, HighContrastSelector, {
            color: 'Highlight'
          }), _defineProperty$2(_selectors9, ".".concat(ButtonGlobalClassNames.msButtonIcon), {
            color: p.neutralPrimary
          }), _selectors9)
        },
        ':active': {
...
function standardStyles(theme) {
  ...
  return {
    ...
    splitButtonDivider: _objectSpread$1({}, splitButtonDividerBaseStyles(), {
      backgroundColor: p.neutralTertiaryAlt,
      selectors: _defineProperty$2({}, HighContrastSelector, {
...
function primaryStyles(theme) {
  ...
  return {
    root: {
      ...
      selectors: (_selectors6 = {}, _defineProperty$2(_selectors6, HighContrastSelector, {
        color: 'Window',
        backgroundColor: 'WindowText',
        MsHighContrastAdjust: 'none'
      }), _defineProperty$2(_selectors6, ".".concat(IsFocusVisibleClassName, " &:focus"), {
        selectors: {
          ':after': {
            border: "none",
    ...
    splitButtonMenuButton: {
      backgroundColor: s.primaryButtonBackground,
      color: s.primaryButtonText,
      selectors: (_selectors13 = {}, _defineProperty$2(_selectors13, HighContrastSelector, {
        backgroundColor: 'WindowText'
      }), _defineProperty$2(_selectors13, ':hover', {
        backgroundColor: s.primaryButtonBackgroundHovered,
        selectors: _defineProperty$2({}, HighContrastSelector, {
          color: 'Highlight'
        })
...
var getStyles$5 = memoizeFunction(function (theme, customStyles) {
  ...
  var splitButtonStyles = {
    ...
    splitButtonDividerDisabled: _objectSpread$2({}, splitButtonDividerBaseStyles, {
      selectors: _defineProperty$2({}, HighContrastSelector, {
...
function (_DefaultButton) {
  ...
  function PrimaryButton() {
    _classCallCheck$2(this, PrimaryButton);
  ...
  return {
    ...
    chevron: [classNames.chevron, {
      ...
      selectors: (_selectors2 = {}, _defineProperty$2(_selectors2, HighContrastSelector, {
        color: 'WindowText',
        MsHighContrastAdjust: 'none'
      }), _defineProperty$2(_selectors2, MediumScreenSelector, {
        fontSize: chevronSmallFontSize
      }), _defineProperty$2(_selectors2, MinimumScreenSelector, {
        fontSize: chevronSmallFontSize
      }), _selectors2)
    }],
    ...
    overflowButton: [classNames.overflowButton, getFocusStyle(theme), SingleLineTextStyle, {
      ...
      height: '100%',
      cursor: 'pointer',
      selectors: _objectSpread$3({}, itemStateSelectors, (_objectSpread2 = {}, _defineProperty$2(_objectSpread2, MinimumScreenSelector, {
        padding: '4px 6px'
      }), _defineProperty$2(_objectSpread2, MediumScreenSelector, {
        fontSize: fonts.mediumPlus.fontSize
      }), _objectSpread2))
    }],
    itemLink: [classNames.itemLink, getFocusStyle(theme), SingleLineTextStyle, _objectSpread$3({}, commonItemStyles, {
      selectors: _objectSpread$3(_defineProperty$2({
        ':focus': {
          color: palette.neutralDark
        }
    ...
    item: [classNames.item, _objectSpread$3({}, commonItemStyles, {
      selectors: {
        ':hover': {
          cursor: 'default'
        }
...
function (_BaseComponent) {
  ...
  _createClass$2(Nav, [{
    ...
    value: function toggleCollapsed(group) {
      if (group.name) {
        var newGroupCollapsed = _objectSpread$4({}, this.isGroupCollapsed, _defineProperty$2({}, group.name, this.isGroupExpanded(group)));
...
var __vue_component__$e = __vue_normalize__({}, __vue_inject_styles__$e, __vue_script__$e, __vue_scope_id__$e, __vue_is_functional_template__$e, __vue_module_identifier__$e, false, undefined, undefined, undefined);
...
var DirectionalDictionary = (_DirectionalDictionar = {}, _defineProperty$2(_DirectionalDictionar, DirectionalHint.topLeftEdge, _createPositionData(RectangleEdge$2.top, RectangleEdge$2.left)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.topCenter, _createPositionData(RectangleEdge$2.top)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.topRightEdge, _createPositionData(RectangleEdge$2.top, RectangleEdge$2.right)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.topAutoEdge, _createPositionData(RectangleEdge$2.top, undefined, true)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.bottomLeftEdge, _createPositionData(RectangleEdge$2.bottom, RectangleEdge$2.left)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.bottomCenter, _createPositionData(RectangleEdge$2.bottom)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.bottomRightEdge, _createPositionData(RectangleEdge$2.bottom, RectangleEdge$2.right)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.bottomAutoEdge, _createPositionData(RectangleEdge$2.bottom, undefined, true)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.leftTopEdge, _createPositionData(RectangleEdge$2.left, RectangleEdge$2.top)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.leftCenter, _createPositionData(RectangleEdge$2.left)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.leftBottomEdge, _createPositionData(RectangleEdge$2.left, RectangleEdge$2.bottom)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.rightTopEdge, _createPositionData(RectangleEdge$2.right, RectangleEdge$2.top)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.rightCenter, _createPositionData(RectangleEdge$2.right)), _defineProperty$2(_DirectionalDictionar, DirectionalHint.rightBottomEdge, _createPositionData(RectangleEdge$2.right, RectangleEdge$2.bottom)), _DirectionalDictionar);
...
function _getOutOfBoundsEdges(rect, boundingRect) {
  ...
  if (rect.top < boundingRect.top) {
    outOfBounds.push(RectangleEdge$2.top);
  }

  if (rect.bottom > boundingRect.bottom) {
    outOfBounds.push(RectangleEdge$2.bottom);
  }

  if (rect.left < boundingRect.left) {
    outOfBounds.push(RectangleEdge$2.left);
  }

  if (rect.right > boundingRect.right) {
    outOfBounds.push(RectangleEdge$2.right);
  }
...
function _getEdgeValue(rect, edge) {
  return rect[RectangleEdge$2[edge]];
}

function _setEdgeValue(rect, edge, value) {
  rect[RectangleEdge$2[edge]] = value;
  return rect;
}
/**
...
function _flipToFit(rect, target, bounding, positionData) {
  ...
  var directions = [RectangleEdge$2.left, RectangleEdge$2.right, RectangleEdge$2.bottom, RectangleEdge$2.top]; // In RTL page, RectangleEdge.right has a higher priority than RectangleEdge.left, therefore the order should be updated.
...
function _getFlankingEdges(edge) {
  if (edge === RectangleEdge$2.top || edge === RectangleEdge$2.bottom) {
    return {
      positiveEdge: RectangleEdge$2.left,
      negativeEdge: RectangleEdge$2.right
    };
  } else {
    return {
      positiveEdge: RectangleEdge$2.top,
      negativeEdge: RectangleEdge$2.bottom
    };
  }
}
/**
...
function _finalizeElementPosition(elementRectangle, hostElement, targetEdge, bounds, alignmentEdge, coverTarget, doNotFinalizeReturnEdge) {
  ...
  var elementEdge = coverTarget ? targetEdge : targetEdge * -1;
  var elementEdgeString = RectangleEdge$2[elementEdge];
  ...
  returnValue[RectangleEdge$2[returnEdge]] = _getRelativeEdgeDifference(elementRectangle, hostRect, returnEdge);
  return returnValue;
...
function _getPositionData() {
  ...
  var positionInformation = _objectSpread$5({}, DirectionalDictionary[directionalHint]);
...
function _finalizeBeakPosition(elementPosition, positionedBeak, bounds) {
  ...
  returnValue[RectangleEdge$2[targetEdge]] = _getEdgeValue(positionedBeak, targetEdge);
  returnValue[RectangleEdge$2[returnEdge]] = _getRelativeEdgeDifference(positionedBeak, actualElement, returnEdge);
  return {
    elementPosition: _objectSpread$5({}, returnValue),
...
function _getTargetRect(bounds, target) {
  ...
  if (target) {
    ...
    if (target.preventDefault) {
      var ev = target;
      targetRectangle = new Rectangle$1(ev.clientX, ev.clientX, ev.clientY, ev.clientY); // @ts-ignore
    ...
    if (!_isRectangleWithinBounds(targetRectangle, bounds)) {
      ...
      try {
        for (var _iterator2 = outOfBounds[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          targetRectangle[RectangleEdge$2[direction]] = bounds[RectangleEdge$2[direction]];
        }
      } catch (err) {
...
function _positionElementRelative(props, elementToPosition, boundingRect, previousPositions) {
  ...
  return _objectSpread$5({}, positionedElement, {
...
function _positionCallout(props, hostElement, callout, previousPositions, doNotFinalizeReturnEdge) {
  ...
  return _objectSpread$5({}, _finalizePositionData(positionedElement, hostElement, boundingRect, props.coverTarget, doNotFinalizeReturnEdge), {
...
function (_BaseComponent) {
  ...
  function CalloutContent() {
    ...
    _classCallCheck$2(this, CalloutContent);
...
var __vue_component__$g = __vue_normalize__({
...
var __vue_scope_id__$h = "data-v-22b4f560";
/* module identifier */
  ...
  var styles = {
    ...
    root: [theme.fonts.medium, {
      ...
      selectors: {
        ...
        '&.is-open': {
          borderColor: root.borderColor,
          selectors: _defineProperty$2({}, HighContrastSelector, ComboBoxRootHighContrastFocused)
        }
      }
    }],
    rootHovered: {
...
var __vue_component__$i = __vue_normalize__({}, __vue_inject_styles__$i, __vue_script__$i, __vue_scope_id__$i, __vue_is_functional_template__$i, __vue_module_identifier__$i, false, undefined, undefined, undefined);
...
var Label$1 = styled(__vue_component__$i, getStyles$g, undefined);
...
function (_Vue) {
  ...
  function Autofill() {
    ...
    _classCallCheck$2(this, Autofill);
...
var __vue_scope_id__$j = "data-v-262125bc";
/* module identifier */
...
ComboBox = __decorate([Component({
  components: {
    Autofill: __vue_component__$j,
    Label: Label$1,
    IconButton: __vue_component__$7
  }
})], ComboBox);
var script$k = ComboBox;
...
function getChoiceGroupFocusStyle(focusBorderColor, hasIconOrImage) {
  return ['is-inFocus', {
    selectors: _defineProperty$2({}, ".".concat(IsFocusVisibleClassName, " &"), {
      position: 'relative',
      outline: 'transparent',
      selectors: {
        '::-moz-focus-inner': {
...
var script$l = ChoiceGroupOption;
...
var __vue_scope_id__$l = "data-v-1a999b6a";
/* module identifier */
...
var Label$2 = styled(__vue_component__$i, getStyles$g, undefined);
...
function (_BaseComponent) {
  ...
  function ChoiceGroup() {
    ...
    _classCallCheck$2(this, ChoiceGroup);
...
ChoiceGroup = __decorate([Component({
  components: {
    ChoiceGroupOption: __vue_component__$l,
    Label: Label$2
  }
})], ChoiceGroup);
var script$m = ChoiceGroup;
...
var getStyles$j = function getStyles(props) {
  ...
  return {
    root: [classNames.root, {
      ...
      selectors: (_selectors3 = {}, _defineProperty$2(_selectors3, ":hover .".concat(classNames.checkbox), {
        borderColor: checkboxBorderHoveredColor,
        selectors: _defineProperty$2({}, HighContrastSelector, {
          borderColor: 'Highlight'
        })
      }), _defineProperty$2(_selectors3, ":focus .".concat(classNames.checkbox), {
        borderColor: checkboxBorderHoveredColor
      }), _defineProperty$2(_selectors3, ":hover .".concat(classNames.checkmark), {
      ...
      selectors: (_selectors5 = {}, _defineProperty$2(_selectors5, ":hover .".concat(classNames.checkbox), {
        background: checkboxBackgroundCheckedHovered,
        borderColor: checkboxBorderColorCheckedHovered
      }), _defineProperty$2(_selectors5, ":focus .".concat(classNames.checkbox), {
        background: checkboxBackgroundCheckedHovered,
        borderColor: checkboxBorderColorCheckedHovered
      }), _defineProperty$2(_selectors5, ".".concat(classNames.checkbox), {
        background: checkboxBorderColorChecked,
        borderColor: checkboxBorderColorChecked
      }), _defineProperty$2(_selectors5, HighContrastSelector, {
        selectors: (_selectors4 = {}, _defineProperty$2(_selectors4, ":hover .".concat(classNames.checkbox), {
          background: 'Window',
          borderColor: 'Highlight'
        }), _defineProperty$2(_selectors4, ":focus .".concat(classNames.checkbox), {
          background: 'Highlight'
        }), _defineProperty$2(_selectors4, ":focus:hover .".concat(classNames.checkbox), {
          background: 'Highlight'
        }), _defineProperty$2(_selectors4, ":focus:hover .".concat(classNames.checkmark), {
          color: 'Window'
        }), _defineProperty$2(_selectors4, ":hover .".concat(classNames.checkmark), {
          color: 'Highlight'
        }), _selectors4)
      }), _selectors5)
    }, indeterminate && {
      selectors: (_selectors6 = {}, _defineProperty$2(_selectors6, ":hover .".concat(classNames.checkbox, ", :hover .").concat(classNames.checkbox, ":after"), {
        borderColor: checkboxBorderIndeterminateHoveredColor
      }), _defineProperty$2(_selectors6, ":focus .".concat(classNames.checkbox), {
        borderColor: checkboxBorderIndeterminateHoveredColor
      }), _defineProperty$2(_selectors6, ":hover .".concat(classNames.checkmark), {
        opacity: '0'
      }), _selectors6)
    }, {
      selectors: (_selectors7 = {}, _defineProperty$2(_selectors7, ":hover .".concat(classNames.text), {
        color: checkboxHoveredTextColor
      }), _defineProperty$2(_selectors7, ":focus .".concat(classNames.text), {
        color: checkboxHoveredTextColor
      }), _selectors7)
    }], className],
    input: {
      ...
      background: 'none',
      opacity: 0,
      selectors: _defineProperty$2({}, ".".concat(IsFocusVisibleClassName, " &:focus + label::before"), {
...
var Checkbox$1 = styled(__vue_component__$n, getStyles$j, undefined);
...
var highContrastAdjustMixin = _defineProperty$2({}, "".concat(HighContrastSelector, ", ").concat(HighContrastSelectorWhite.replace('@media ', '')), {
  MsHighContrastAdjust: 'none'
});

var highContrastItemAndTitleStateMixin = {
  selectors: _objectSpread$7(_defineProperty$2({}, HighContrastSelector, {
    backgroundColor: 'Highlight',
    borderColor: 'Highlight',
    color: 'HighlightText'
...
var getStyles$k = function getStyles(props) {
  ...
  var itemSelectors = function itemSelectors() {
    ...
    return {
      ...
      }, _defineProperty$2(_selectors2, HighContrastSelector, {
        borderColor: 'Window'
      }), _defineProperty$2(_selectors2, ".".concat(IsFocusVisibleClassName, " &:focus:after"), {
        left: 0,
        top: 0,
        bottom: 0,
        right: 0
  ...
  return {
    ...
    dropdown: [globalClassnames.dropdown, normalize, fonts.medium, {
      ...
      outline: 0,
      userSelect: 'none',
      selectors: (_selectors3 = {}, _defineProperty$2(_selectors3, '&:hover .' + globalClassnames.title, [!disabled && rootHoverFocusActiveSelectorNeutralDarkMixin, {
        borderColor: !isOpen ? palette.neutralPrimary : palette.themePrimary
      }, highContrastBorderState]), _defineProperty$2(_selectors3, '&:focus .' + globalClassnames.title, [!disabled && rootHoverFocusActiveSelectorNeutralDarkMixin]), _defineProperty$2(_selectors3, '&:focus:after', [{
        pointerEvents: 'none',
        content: "''",
        position: 'absolute',
        boxSizing: 'border-box',
        ...
        borderRadius: '2px'
      }, highContrastItemAndTitleStateMixin]), _defineProperty$2(_selectors3, '&:active .' + globalClassnames.title, [!disabled && rootHoverFocusActiveSelectorNeutralDarkMixin, {
        borderColor: palette.themePrimary
      }, highContrastBorderState]), _defineProperty$2(_selectors3, '&:hover .' + globalClassnames.caretDown, !disabled && rootHoverFocusActiveSelectorNeutralPrimaryMixin), _defineProperty$2(_selectors3, '&:focus .' + globalClassnames.caretDown, [!disabled && rootHoverFocusActiveSelectorNeutralPrimaryMixin, {
        selectors: _objectSpread$7(_defineProperty$2({}, HighContrastSelector, {
          color: 'HighlightText'
        }), highContrastAdjustMixin)
      }]), _defineProperty$2(_selectors3, '&:active .' + globalClassnames.caretDown, !disabled && rootHoverFocusActiveSelectorNeutralPrimaryMixin), _defineProperty$2(_selectors3, '&:hover .' + globalClassnames.titleIsPlaceHolder, !disabled && rootHoverFocusActiveSelectorNeutralPrimaryMixin), _defineProperty$2(_selectors3, '&:focus .' + globalClassnames.titleIsPlaceHolder, !disabled && rootHoverFocusActiveSelectorNeutralPrimaryMixin), _defineProperty$2(_selectors3, '&:active .' + globalClassnames.titleIsPlaceHolder, !disabled && rootHoverFocusActiveSelectorNeutralPrimaryMixin), _defineProperty$2(_selectors3, '&:hover .' + globalClassnames.titleHasError, borderColorError), _defineProperty$2(_selectors3, '&:active .' + globalClassnames.titleHasError, borderColorError), _selectors3)
    ...
    dropdownItemHeader: [globalClassnames.dropdownItemHeader, _objectSpread$7({}, fonts.medium, {
      fontWeight: FontWeights.semibold,
    ...
    subComponentStyles: {
      ...
      panel: {
        root: [panelClassName],
        main: {
          selectors: _defineProperty$2({}, MinimumScreenSelector$1, {
            // panelWidth xs
            width: 272
          })
        },
...
var Dropdown$1 = styled(__vue_component__$o, getStyles$k, undefined);
...
function (_BaseComponent) {
  ...
  function MessageBar() {
    ...
    _classCallCheck$2(this, MessageBar);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MessageBar).apply(this, arguments));
    _this.ICON_MAP = (_this$ICON_MAP = {}, _defineProperty$2(_this$ICON_MAP, MessageBarType.info, 'Info'), _defineProperty$2(_this$ICON_MAP, MessageBarType.warning, 'Info'), _defineProperty$2(_this$ICON_MAP, MessageBarType.error, 'ErrorBadge'), _defineProperty$2(_this$ICON_MAP, MessageBarType.blocked, 'Blocked2'), _defineProperty$2(_this$ICON_MAP, MessageBarType.severeWarning, 'Warning'), _defineProperty$2(_this$ICON_MAP, MessageBarType.success, 'Completed'), _this$ICON_MAP);
    return _this;
  }

  _createClass$2(MessageBar, [{
    key: "classNames",
    get: function get() {
      var theme = this.theme,
          className = this.className,
...
var __vue_scope_id__$p = "data-v-2a92ffc4";
/* module identifier */
...
var getStyles$l = function getStyles(props) {
  ...
  return {
    ...
    text: [classNames.text, _objectSpread$8({
      minWidth: 0,
      display: 'flex',
      flexGrow: 1,
      margin: 8
    ...
    innerText: [classNames.innerText, {
      ...
      selectors: _defineProperty$2({}, SmallScreenSelector, {
        overflow: 'visible',
        whiteSpace: 'pre-wrap'
      })
    }, expandSingleLine && {
...
var MessageBar$1 = styled(__vue_component__$p, getStyles$l, undefined);
...
var __vue_scope_id__$q = "data-v-7d1dd636";
/* module identifier */
...
var __vue_component__$q = __vue_normalize__({}, __vue_inject_styles__$q, __vue_script__$q, __vue_scope_id__$q, __vue_is_functional_template__$q, __vue_module_identifier__$q, false, undefined, undefined, undefined);
...
var getStyles$m = function getStyles(props) {
  ...
  return {
    root: [classNames.root, theme.fonts.medium, {
      ...
      selectors: (_selectors3 = {}, _defineProperty$2(_selectors3, HighContrastSelectorBlack, {
        color: '#FFFF00'
      }), _defineProperty$2(_selectors3, HighContrastSelectorWhite, {
        color: '#00009F'
      }), _selectors3)
    }, !isButton && {
      textDecoration: 'none'
...
var Link$1 = styled(__vue_component__$r, getStyles$m, undefined);
...
var Overlay$1 = styled(__vue_component__$s, getStyles$n, undefined);

var Overlay$2 = styled(__vue_component__$s, getStyles$n, undefined);
...
var script$u = ProgressIndicator;
...
var ProgressIndicator$1 = styled(__vue_component__$u, getStyles$o, undefined);
...
var Rating$1 = styled(__vue_component__$v, getStyles$p, undefined);
...
function getStyles$q(props) {
  ...
  return {
    root: [classNames.root, fonts.medium, normalize, {
      ...
      selectors: (_selectors2 = {}, _defineProperty$2(_selectors2, HighContrastSelector, {
        border: '1px solid WindowText'
      }), _defineProperty$2(_selectors2, ':hover', {
        borderColor: semanticColors.inputBorderHovered,
        selectors: _defineProperty$2({}, HighContrastSelector, {
          borderColor: 'Highlight'
        })
      }), _defineProperty$2(_selectors2, ":hover .".concat(classNames.iconContainer), {
        color: semanticColors.inputIconHovered
      }), _selectors2)
    }, !hasFocus && hasInput && {
      selectors: (_selectors3 = {}, _defineProperty$2(_selectors3, ":hover .".concat(classNames.iconContainer), {
        width: 4
      }), _defineProperty$2(_selectors3, ":hover .".concat(classNames.icon), {
        opacity: 0
      }), _selectors3)
    }, hasFocus && ['is-active', {
...
var SearchBox$1 = styled(__vue_component__$w, getStyles$q, undefined);
...
var __vue_component__$x = __vue_normalize__({}, __vue_inject_styles__$x, __vue_script__$x, __vue_scope_id__$x, __vue_is_functional_template__$x, __vue_module_identifier__$x, false, undefined, undefined, undefined);
...
var Separator$1 = styled(__vue_component__$x, getStyles$r, undefined);
...
var getStyles$s = function getStyles(props) {
  ...
  return {
    ...
    slideBox: [classNames.slideBox, getFocusStyle(theme), {
      ...
      display: 'flex',
      alignItems: 'center',
      selectors: (_selectors6 = {}, _defineProperty$2(_selectors6, ":active .".concat(classNames.activeSection), slideBoxActiveSectionStyles), _defineProperty$2(_selectors6, ":hover .".concat(classNames.activeSection), slideHoverSectionStyles), _defineProperty$2(_selectors6, ":active .".concat(classNames.inactiveSection), slideBoxInactiveSectionStyles), _defineProperty$2(_selectors6, ":hover .".concat(classNames.inactiveSection), slideBoxInactiveSectionStyles), _defineProperty$2(_selectors6, ":active .".concat(classNames.thumb), slideBoxActiveThumbStyles), _defineProperty$2(_selectors6, ":hover .".concat(classNames.thumb), slideBoxActiveThumbStyles), _defineProperty$2(_selectors6, ":active .".concat(classNames.zeroTick), slideBoxActiveZeroTickStyles), _defineProperty$2(_selectors6, ":hover .".concat(classNames.zeroTick), slideBoxActiveZeroTickStyles), _selectors6)
    }, vertical ? {
      height: '100%',
      width: 28,
      padding: '8px 0'
...
var Slider$1 = styled(__vue_component__$y, getStyles$s, undefined);
...
var Spinner$1 = styled(__vue_component__$z, getStyles$t, undefined);
...
var Text$1 = styled(__vue_component__$A, getStyles$u, undefined);
...
function (_BaseComponent) {
  ...
  function TextField() {
    ...
    _classCallCheck$2(this, TextField);
  ...
  _createClass$2(TextField, [{
    ...
    value: function onMultilineChanged(newValue, oldValue) {
      var textElement, start, end;
      return regeneratorRuntime.async(function onMultilineChanged$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
    ...
    value: function onFocus() {
      return regeneratorRuntime.async(function onFocus$(_context2) {
        while (1) {
    ...
    return {
      ...
      selectors: {
        ':after': (_after = {
          ...
          bottom: -1,
          right: -1
        }, _defineProperty$2(_after, borderType, '2px solid ' + color), _defineProperty$2(_after, "borderRadius", effects.roundedCorner2), _defineProperty$2(_after, "width", borderType === 'borderBottom' ? '100%' : undefined), _defineProperty$2(_after, "selectors", _defineProperty$2({}, HighContrastSelector, _defineProperty$2({}, borderType === 'border' ? 'borderColor' : 'borderBottomColor', 'Highlight'))), _after)
      }
    };
  };
...
var TextField$1 = styled(__vue_component__$B, getStyles$v, undefined);
...
var Toggle$1 = styled(__vue_component__$C, getStyles$w, undefined);
...
var sizeToPixels = (_sizeToPixels = {}, _defineProperty$2(_sizeToPixels, PersonaSize.tiny, 10), _defineProperty$2(_sizeToPixels, PersonaSize.extraExtraSmall, 24), _defineProperty$2(_sizeToPixels, PersonaSize.extraSmall, 28), _defineProperty$2(_sizeToPixels, PersonaSize.small, 40), _defineProperty$2(_sizeToPixels, PersonaSize.regular, 48), _defineProperty$2(_sizeToPixels, PersonaSize.large, 72), _defineProperty$2(_sizeToPixels, PersonaSize.extraLarge, 100), _defineProperty$2(_sizeToPixels, PersonaSize.size8, 8), _defineProperty$2(_sizeToPixels, PersonaSize.size10, 10), _defineProperty$2(_sizeToPixels, PersonaSize.size16, 16), _defineProperty$2(_sizeToPixels, PersonaSize.size24, 24), _defineProperty$2(_sizeToPixels, PersonaSize.size28, 28), _defineProperty$2(_sizeToPixels, PersonaSize.size32, 32), _defineProperty$2(_sizeToPixels, PersonaSize.size40, 40), _defineProperty$2(_sizeToPixels, PersonaSize.size48, 48), _defineProperty$2(_sizeToPixels, PersonaSize.size56, 56), _defineProperty$2(_sizeToPixels, PersonaSize.size72, 72), _defineProperty$2(_sizeToPixels, PersonaSize.size100, 100), _defineProperty$2(_sizeToPixels, PersonaSize.size120, 120), _sizeToPixels);
...
}, __vue_inject_styles__$D, __vue_script__$D, __vue_scope_id__$D, __vue_is_functional_template__$D, __vue_module_identifier__$D, false, __vue_create_injector__, undefined, undefined);
...
function loadTheme$1(theme) {
  ...
  if (useCSSVars) {
    ...
    _theme = loadTheme(_objectSpread$9({}, theme, {
      palette: palette,
...
function install(Vue) {
  ...
  _theme = loadTheme$1(theme, useCSSVars);
...
export { __vue_component__$3 as ActionButton, __vue_component__ as ActivityItem, __vue_component__$9 as Breadcrumb, __vue_component__$h as Callout, Checkbox$1 as Checkbox, __vue_component__$m as ChoiceGroup, __vue_component__$k as ComboBox, __vue_component__$4 as CommandBarButton, __vue_component__$5 as CompoundButton, __vue_component__$6 as DefaultButton, __vue_component__$d as Dialog, Dropdown$1 as Dropdown, index as FabricComponents, Icon$1 as Icon, __vue_component__$7 as IconButton, __vue_component__$f as Image, ImageCoverStyle, ImageFit, ImageLoadState, Label$1 as Label, __vue_component__$a as Layer, __vue_component__$b as LayerHost, Link$1 as Link, MessageBar$1 as MessageBar, MessageBarType, __vue_component__$c as Modal, __vue_component__$e as Nav, Overlay$1 as Overlay, __vue_component__$t as Panel, __vue_component__$D as Persona, PersonaInitialsColor, PersonaPresence, PersonaSize, __vue_component__$q as Popup, __vue_component__$8 as PrimaryButton, ProgressIndicator$1 as ProgressIndicator, Rating$1 as Rating, SearchBox$1 as SearchBox, Separator$1 as Separator, __vue_component__$E as Shimmer, Slider$1 as Slider, Spinner$1 as Spinner, Text$1 as Text, TextField$1 as TextField, Toggle$1 as Toggle, loadTheme$1 as loadTheme };
