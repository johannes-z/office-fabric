...
export class AutoScroll {
  ...
  private _computeScrollVelocity (ev: MouseEvent | TouchEvent): void {
    ...
    const scrollRectTop = this._scrollRect.top
    const scrollRectLeft = this._scrollRect.left
    const scrollClientBottom = scrollRectTop + this._scrollRect.height - SCROLL_GUTTER
    const scrollClientRight = scrollRectLeft + this._scrollRect.width - SCROLL_GUTTER
