...
import type { IStyle } from '@fluentui-vue/style-utilities'
...
function getLinkStyles(props: IPivotStyleProps,
  classNames: { [key: string]: string },
  isLinkInOverflowMenu = false): IStyle[] {
...
export function getStyles(props: IPivotStyleProps): IPivotStyles {
