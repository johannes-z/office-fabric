...
export interface IColorPickerGridCellProps {
   ...
   */
  onClick?: (item: IColorCellProps, event?: MouseEvent) => void

  onHover?: (item?: IColorCellProps, event?: MouseEvent) => void

  onFocus?: (item: IColorCellProps, event?: FocusEvent) => void
