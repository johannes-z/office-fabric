...
export interface INavProps {
   ...
   */
  onLinkClick?: (ev?: MouseEvent, item?: INavLink) => void

  /**
   * Function callback invoked when the chevron on a link is clicked
   */
  onLinkExpandClick?: (ev?: MouseEvent, item?: INavLink) => void
...
export interface INavLinkGroup {
   ...
   */
  onHeaderClick?: (ev?: MouseEvent, isCollapsing?: boolean) => void
...
export interface INavLink {
   ...
   */
  onClick?: (ev?: MouseEvent, item?: INavLink) => void
