import { AnimationStyles, FontSizes, FontWeights, HighContrastSelector, getFocusStyle, normalize } from '@fluentui-vue/style-utilities'
import type { ICalendarDayStyleProps, ICalendarDayStyles } from './CalendarDay.types'

export function getStyles(props: ICalendarDayStyleProps): ICalendarDayStyles {
